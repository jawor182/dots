...
vim.keymap.set("n", "<Leader>wp", ":VimwikiDiaryPrevDay<CR>", { desc = "Open diary for yesterday" })
vim.keymap.set("n", "<Leader>wn", ":VimwikiDiaryNextDay<CR>", { desc = "Open diary for tomorrow" })
