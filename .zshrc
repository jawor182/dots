...
alias cfr="$EDITOR ~/dots/.config/rmpc/config.ron"
alias cfm="$EDITOR ~/dots/.config/mpd/mpd.conf"
alias cfz="$EDITOR ~/dots/.zshrc"
alias cff="$EDITOR ~/dots/.config/foot/foot.ini"
alias cfk="$EDITOR ~/dots/.config/kitty/kitty.conf"
alias cfh="$EDITOR ~/dots/.config/hypr/hyprland.conf"
alias cfl="$EDITOR ~/dots/.config/hypr/hyprlock.conf"
alias cfi="$EDITOR ~/dots/.config/hypr/hypridle.conf"
...
alias wd="cd ~/wayland-suckless/dwl/"
alias d="cd ~/dox"
